...
int main(int argc, char *argv[])
{
    ...
    //part0(s1,s2);
    fcfs(s1,s2,iIn[1],iIn[2],iIn[3],iIn[4],iIn[5],iIn[6]);
    display("FCFS\n",s1,s2);

    sjf(s1,s2,iIn[1],iIn[2],iIn[3],iIn[4],iIn[5],iIn[6]);
    display("\n SJF \n", s1, s2);
    psjf(s1,s2,iIn[1],iIn[2],iIn[3],iIn[4],iIn[5],iIn[6]);
    display("\n PSJF \n", s1, s2);
    rr(s1,s2,iIn[0],iIn[1],iIn[2],iIn[3],iIn[4],iIn[5],iIn[6]);
    display("\n RR \n", s1, s2);
    return 0;
}
