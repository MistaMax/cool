/*********************************************************************************
    ...
    Copyright 2018 Larry Clark, this code must not be copied to any other website
Purpose:
